 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_iso_docrobot_settings']['iso_docrobot_legend']      = 'DocRobot Einstellungen';

/**
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_iso_docrobot_settings']['edit'] = 'DocRobot Einstellungen bearbeiten';